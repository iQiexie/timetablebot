...
menu_keyboard.row()
menu_keyboard.add(Text("Эта неделя", {"cmd": "sweek", 'next': False}), KeyboardButtonColor.SECONDARY)
menu_keyboard.add(Text("Следующая неделя", {"cmd": "sweek", 'next': True}), KeyboardButtonColor.SECONDARY)
menu_keyboard.row()
