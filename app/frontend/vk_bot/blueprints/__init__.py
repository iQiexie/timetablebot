from app.frontend.vk_bot import blueprint as gpt_blueprint
...
from app.frontend.vk_bot.blueprints.settings.statistics import blueprint as admin_blueprint
from app.frontend.vk_bot.blueprints.settings.statistics import blueprint as statistics_blueprint
